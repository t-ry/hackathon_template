...
import app.takahashi.kamesan.template.databinding.ActivityAlarmBinding
import java.util.*
...
class AlarmActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAlarmBinding.inflate(layoutInflater).apply { setContentView(this.root) }
