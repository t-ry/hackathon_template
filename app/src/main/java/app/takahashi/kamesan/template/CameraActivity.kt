...
import app.takahashi.kamesan.template.databinding.ActivityCameraBinding
...
//                        takePhoto()
//                        //viewBinding.imageCaptureButton.isEnabled = faces > 0
//                    })
//                }
    ...
    // なんかピクセルの平均値の計算っぽい？調べた感じML kitと合わせて画像解析とか使えそうだけどML kitがわからない。
